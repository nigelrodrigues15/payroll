...
(async () => {
    try {
        ...
        await page.type('input[id="employeeName"]', employeeName);
        
        await page.waitFor('input[id="employerName"]');
        let employerName = 'Edo Japan';
        await page.type('input[id="employerName"]', employerName);
        ...
        await page.type('input[id="incomeAmount"]', payperiodSalary);
        
        await page.waitFor('input[id="vacationPay"]');
        let vacationPay = '100';
        await page.type('input[id="vacationPay"]', vacationPay);
